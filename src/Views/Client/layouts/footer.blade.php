             ...
             <div class="row g-5">
                 ...
                 <div class="col-6 col-lg-2">
                     ...
                     <ul class="footer-links list-unstyled">
                         ...
                         <li>
                             <a href="single-post.html"><i class="bi bi-chevron-right"></i>
                                 Single Post</a>
                         </li>
                         <li>
                     ...
                     <ul class="footer-links footer-blog-entry list-unstyled">
                         <li>
                             <a href="single-post.html" class="d-flex align-items-center">
                                 <img src="/MVCOOP/assets/client/assets/img/post-sq-1.jpg" alt="" class="img-fluid me-3" />
                                 <div>
                         ...
                         <li>
                             <a href="single-post.html" class="d-flex align-items-center">
                                 <img src="/MVCOOP/assets/client/assets/img/post-sq-2.jpg" alt="" class="img-fluid me-3" />
                                 <div>
                                     <div class="post-meta d-block">
                                         <span class="date">Culture</span>
                                         <span class="mx-1">&bullet;</span>
                         ...
                         <li>
                             <a href="single-post.html" class="d-flex align-items-center">
                                 <img src="/MVCOOP/assets/client/assets/img/post-sq-3.jpg" alt="" class="img-fluid me-3" />
                                 <div>
                                     <div class="post-meta d-block">
                                         <span class="date">Culture</span>
                                         <span class="mx-1">&bullet;</span>
                         ...
                         <li>
                             <a href="single-post.html" class="d-flex align-items-center">
                                 <img src="/MVCOOP/assets/client/assets/img/post-sq-4.jpg" alt="" class="img-fluid me-3" />
                                 <div>
                                     <div class="post-meta d-block">
                                         <span class="date">Culture</span>
                                         <span class="mx-1">&bullet;</span>
